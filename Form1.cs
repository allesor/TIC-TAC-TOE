...
namespace TicTacToe
{
    public partial class Form1 : Form
    {
        ...
        private static Administrator admin = new Administrator("Admin", "admin", "admin");
        ...
        {
            InitializeComponent();
            if (Form1.LoggedInUser is Administrator)
            {
                MessageBox.Show("Administrators cannot play the game.");
                Application.Exit();
            }
            restart_matrix();
            player1_turn = true;
        ...
        public static User LoggedInUser { get => loggedInUser; set => loggedInUser = value; }
        public static Administrator Admin { get => admin; }
